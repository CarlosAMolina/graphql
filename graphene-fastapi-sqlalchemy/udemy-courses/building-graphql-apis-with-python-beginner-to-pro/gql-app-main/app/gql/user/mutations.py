...
from app.utils import hash_password, get_authenticated_user, authd_user_same_as
...
class AddUser(Mutation):
    ...
    # input_func -> decorator -> output_func (typically modified/extended)
    # define decorator for admin_user
    # use it
    #     @admin_user
    #     def mutate
    #         pass
